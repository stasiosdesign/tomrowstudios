...
(function () {
  ...
  const DEFAULTS = {
    ...
    restHeight: 6,     // total height of a stroke at rest
    maxHeight: 128,    // total height of the stroke under the pointer
    radius: 150,       // horizontal reach of the field, centre to edge
