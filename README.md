...
There is deliberately no separate "publish to staging" step for content:
unpublished changes are previewed as drafts in the Visual editor, and
**Publish** puts them live. Staging is for reviewing code.
